...
async function importData() {
  try {
    ...
    // Fetch food and chef data simultaneously
    const $Promise = [];
    $Promise.push(axios.get('https://sanity-nextjs-rouge.vercel.app/api/foods'));
    $Promise.push(axios.get('https://sanity-nextjs-rouge.vercel.app/api/chefs'));
    ...
    console.log(`Fetched ${chefs.length} chefs`);
